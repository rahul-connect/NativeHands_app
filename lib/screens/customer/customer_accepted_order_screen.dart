...
class CustomerAcceptedOrderScreen extends StatefulWidget {
  final Stream acceptedStream;
  final Firestore firestore;
  final scaffold;
  CustomerAcceptedOrderScreen({@required this.acceptedStream,@required this.firestore ,@required this.scaffold});
  @override
  _CustomerAcceptedOrderScreenState createState() => _CustomerAcceptedOrderScreenState();
}

class _CustomerAcceptedOrderScreenState extends State<CustomerAcceptedOrderScreen> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
          stream: widget.acceptedStream,
                          ...
                          children: <Widget>[
                              for(var product in snapshot.data.documents[index]['products'])
                               Padding(
                                ...
                                snapshot.data.documents[index]['price_modified']?Container(margin: EdgeInsets.symmetric(vertical: 5.0),alignment: Alignment.center,child: Text('New Price : Rs.${snapshot.data.documents[index]['new_total']}',style: TextStyle(fontSize: 18.0,color: Colors.black,fontWeight: FontWeight.bold),)):SizedBox.shrink(),
